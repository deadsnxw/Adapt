...
export default function SettingsForm({ formData, onInputChange, onUpdate, onDelete }) {
    return (
        <form className={styles.settingsForm} onSubmit={onUpdate}>
            <div className={styles.formGroup}>
                ...
                <div className={styles.buttonContainer}>
                    <button className={styles.button} name="update" type="submit">Update</button>
                    <button className={styles.button} name="delete" onClick={onDelete}>Delete Account</button>
                </div>
            </div>
        </form>
    )
